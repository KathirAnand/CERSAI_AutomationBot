...
public class SatisfactionPage extends BasePage {
	...
	/**
	 * This method clicks the proceed button. If the Security Interest ID is
	 * entered, then proceed button should be clicked by using this method
	 */
	...
	/**
	 * This method clicks the close button. If the message "Security Interest is
	 * already satisfied" is displayed then close icon should be clicked by using
	 * this method
	 */
	...
	/**
	 * This method will return true, if the "Security Interest is already satisfied"
	 * is displayed otherwise it will return false while submitting
	 * 
	 * @return
	 */
	...
	/**
	 * This method will return true, if the error message "Field Length must be 12"
	 * is displayed otherwise it will return false while entering the Security
	 * Interest ID
	 * 
	 * @return
	 */
	...
	/**
	 * This method will return true, if the error message "Field must be Number" is
	 * displayed otherwise it will return false while entering the Security Interest
	 * ID
	 * 
	 * @return
	 */
