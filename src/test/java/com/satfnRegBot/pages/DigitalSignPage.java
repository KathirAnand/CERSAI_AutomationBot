...
public class DigitalSignPage extends BasePage {
	...
	@FindBy(xpath="//span[contains(text(),'Signing was cancelled by the user.')]")
	protected WebElement signingCancelledErrMsg;
	...
	public void enterUserPIN(String pin) throws AWTException{
		Robot robot =new Robot();
		pin=pin.toLowerCase();
	...
	public void clickLoginUsingKeyboard() throws AWTException {
		Robot robot =new Robot();
		robot.keyPress(KeyEvent.VK_ENTER);
